...
def main():
    ...
    # download_meta('commander_1v1', 1, 4)
    # download_meta('vintage', 1)
    # download_meta('legacy', 1)
    # download_meta('modern', 1, 2)
    # download_meta('standard', 1)
    # download_meta('pioneer', 1)
    # download_meta('pauper', 1)

    download_meta('modern')
    download_meta('legacy')
    download_meta('vintage')
    download_meta('pioneer')
    download_meta('pauper')
    download_meta('commander_1v1')
    download_meta('standard')
    download_meta('penny_dreadful')
    download_meta('historic_brawl')
